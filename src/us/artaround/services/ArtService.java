...
public class ArtService extends BaseService {
	...
	public static ParseResult getArt(int perPage, int page) throws ArtAroundException {
		StringBuilder query = new StringBuilder().append(PARAM_PER_PAGE).append("=").append(perPage).append("&")
				.append(PARAM_PAGE).append("=").append(page).append("&").append(PARAM_ORDER).append("=")
