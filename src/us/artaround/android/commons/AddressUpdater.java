...
public class AddressUpdater extends AsyncTask<Location, Void, String> {
	// cache the addresses already obtained for different locations
	...
	protected String doInBackground(Location... params) {
		...
		try {
			...
			List<Address> addresses = new Geocoder((Context) context).getFromLocation(location.getLatitude(), location
					.getLongitude(), 1);
